  ...
  return (
    <>
      <section className="store-details__section">
        <h3 className="store-details__section-title">
          Inventory at this store
        </h3>
        {isInventoryLoading ? (
          <Loader />
        ) : isInventoryError ? (
          <ErrorState
            body="Couldn't load inventory for this store."
          ...
          <p className="store-details__empty">
            No inventory recorded for this store.
          </p>
        )}
      </section>
      ...
      <section className="store-details__section">
        ...
        {isOrdersLoading ? (
          ...
          <ErrorState
            body="Couldn't load orders for this store."
          ...
          <ul className="store-details__list">
            {storeOrders.map((order) => (
              <li key={order.orderid} className="store-details__list-row">
                <span className="store-details__list-primary">
                  Order #{order.orderid}
                </span>
