  ...
  return (
    <div className="customer-details">
      ...
      <header className="customer-details__header">
        <span className="customer-details__avatar">
      ...
      <section className="customer-details__section">
        ...
        {isOrdersLoading ? (
          ...
          <ErrorState
            body="Couldn't load orders for this customer."
          ...
          <ul className="customer-details__list">
            {ordersData.orders.map((order) => (
              <li
                ...
                className="customer-details__list-row"
              >
        ...
        {isShipmentsLoading ? (
          ...
          <ul className="customer-details__list">
            {shipmentsData.shipments.map((shipment) => (
              <li
                key={shipment.id ?? shipment.shipment_id}
                className="customer-details__list-row"
              >
                <span className="customer-details__list-primary">
